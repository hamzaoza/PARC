export const Site1 = {
	...
	"summary" : "A small CF clinic with under 40 patients, clinics are held in a busy outpatients department in a 1970's built hospital. Patients are cohorted according to whether they are infected with Pseudomonas aeruginosa. Patients with Mycobacterium abscessus and Burkholderia cepacia complex (Bcc) are treated in isolation.",
	"hotspots" : [{
		"name" : "entrance",
		"position" : [-17.5, 4, 14],
		"data" : {
